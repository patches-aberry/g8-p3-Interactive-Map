...
function generateResultTable() {
    ...
    var result = ""
    var tr1 = "<tr><th>" + "Population" +       "</th><td>" + s1Pop[0].TotalPopulation + "</th><td>" + s2Pop[0].TotalPopulation + "</td><td>" + "330900000" + "</td></tr>";
    //console.log(tr1)
    var tr2 = "<tr><th>" + "GDP (USD)" +              "</th><td>" + s1GDP[0].GDP + "</td><td>" + s2GDP[0].GDP + "</td><td>" + "23320000000" + "</th></tr>";
    var tr3 = "<tr><th>" + "Whiteness" +        "</th><td>" + Math.round(s1White[0].PercentageWhite*100) + "%</th><td>" + Math.round(s2White[0].PercentageWhite*100) + "%</td><td>" + "75.8 %" + "</td></tr>";
    var tr4 = "<tr><th>" + "Vaccination Rate" + "</th><td>" + s1Vax[0].VaccinationRate.toFixed(2) + "</td><td>" + s2Vax[0].VaccinationRate.toFixed(2) + "</td><td>" + "70.0" + "</td></tr>";
    ...
    var tr6 = "<tr><th>" + "Wine Production (gal)" + "</th><td>" + s1Wine[0].WineProduction + "</td><td>" + s2Wine[0].WineProduction + "</td><td>" + "806135820" + "</td></tr>";
